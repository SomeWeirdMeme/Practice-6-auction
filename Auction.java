...
public class Auction
{
    ...
    public void makeABid(int lotNumber, Person bidder, long value)
    {
        ...
        if(selectedLot != null) {
            boolean successful = selectedLot.bidFor(new Balls(bidder, value));
            if(successful) {
                ...
                Balls highestBid = selectedLot.getHighestBid();
    ...
    public void closeLots(){
        for(Lot f : listOfLots){
            Balls erf = f.getHighestBid();
            
            if(erf != null){
                System.out.println("Lot " + f.getNumber() + " :  " + f.getDescription() + " Sold to the poor guy " + erf.getBidder().getName() + " fo " + erf.getValue());
                
            } else{
                System.out.println( "Lot " + f.getNumber() + ": " + f.getDescription() + " naw" );
            }
        }
    }
